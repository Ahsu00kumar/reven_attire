...
<head>
    ...
    <title>Reven Attire || Show Now</title>
    ...
    <div>
        ...
        <section class="hero">
            <div class="hero__slider owl-carousel">
                ...
                <div class="hero__items set-bg" data-setbg="assets/images/02_51.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-5 col-lg-7 col-md-8 ps-5">
                                <div class="hero__text">
                                    ...
                                    <a href="#" class="primary-btn">Shop now <span class=""><i class="fa fa-arrow-right"></i></span></a>
                ...
                <div class="hero__items set-bg" data-setbg="assets/images/02_52.png">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-5 col-lg-8 col-md-8 ps-5">
                                <div class="hero__text">
                                    <h6>Summer Collection</h6>
        ...
        <section class="socail_media">
            <div class="header__top">
                <div class="container">
                    <div class="socail_media__under text-center">
